                    ...
                    {isLoading ? (
                      [...Array(3)].map((_, i) => (
                        <tr key={i} className="border-b animate-pulse text-sm">
                          <td className="p-4"><div className="h-4 bg-gray-200 rounded w-20 mb-2"></div><div className="h-3 bg-gray-200 rounded w-16"></div></td>
                          <td className="p-4"><div className="h-4 bg-gray-200 rounded w-24 mb-2"></div><div className="h-3 bg-gray-200 rounded w-20"></div></td>
                      ...
                      appointments.map(app => (
                        <tr key={app.id} className="border-b text-sm transition-colors hover:bg-gray-50">
          ...
          {activeTab === 'reviews' && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {isLoading ? (
                  [...Array(4)].map((_, i) => (
                    <div key={i} className="border p-4 rounded bg-gray-50 animate-pulse flex flex-col justify-between">
                      <div>
                  ...
                  reviews.map(rev => (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center border-t pt-4">
                        ...
                        <div className="flex gap-2">
                          {!rev.approved && (
                            <button onClick={() => approveReview(rev.id)} className="p-2 text-green-600 hover:bg-green-50 rounded transition-colors" title="Approve">
